 ...
 *
 * See [Movie List Query](https://github.com/danepod/movie-database/blob/master/src/resources/movie/list/collectionjson/actions.ts#L141) for a concrete example of this.
 */
